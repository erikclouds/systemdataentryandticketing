...
if(isset($_POST['Kotaasal']) and isset($_POST['Kotatujuan']) and isset($_POST['tanggal'])){
  ...
  $query = mysqli_query($conn, "SELECT 	id_reservasi, seat, nama, jam, alamat_jemput, alamat_tujuan, nomor_telepon from data_penumpang where kotaasal like '%".$Kotaasal."%' and kotatujuan like '%".$Kotatujuan."%' and tanggal_berangkat like '%".$tanggal."%' and status_reservasi = 'ACTIVE'" );				
  $no=0;
  while ($data = mysqli_fetch_array($query)) {
    ...
    <tr>
      ...
      <td>
        <div class="btn-group">
          <a href="Edit.php?id_reservasi=<?php echo $data['id_reservasi']; ?>"><button type="button" class="tombolcari" name="Edit"><b>Edit</b></button></a>
          <a href="hapus.php?id_reservasi=<?php echo $data['id_reservasi']; ?>" onclick="return confirm('Apa Anda Akan Menghapus Data?')"><button class="tombolhapus" type="button" name="hapus"><b>Hapus</b></button></a>
        </div>
      </td>
    </tr>
    <?php }
