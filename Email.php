...
if(isset($_POST[$var])) {
  ...
  $Agen_Pendaftar = mysqli_real_escape_string($conn, $_POST['Agen_Pendaftar']);
...
<?php
          if ($_SESSION['jabatan_user'] == "SUPER ADMIN"){
            echo ' 
            <li class="sub-menu">
...
<section class="panel">  
  ...
  <br>
          <table class="table table-striped table-advance table-hover" >
              <tr>
                <th><i class="fa fa-book"></i> Tanggal :</th>
                <th >
                ...
                <th><textarea name="Alamat_Tujuan" placeholder="Tulis Pesan ...." class="kolomtextarea" required></textarea></th>
              </tr>
              <tr>
                <th></th>
                <th>
